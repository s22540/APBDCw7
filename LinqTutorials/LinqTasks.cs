...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            var result = Emps.Where(e => e.Salary == maxSalary);
            return result;
        }
        ...
        {
            var result = Emps.Where(e => e.Job.Contains('A'))
                             .GroupBy(e => e.Job)
                             .Where(g => g.Count() > 2)
        ...
        {
            var result = Emps.Select(e => new { e, Depts })
                             .SelectMany(
                                x => x.Depts,
                                (e, d) => new { Emp = e.e, Dept = d });
            return result;
        }
    }
